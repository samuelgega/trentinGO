...
export { default as GestisciPDI} from './GestisciPDI';
export { default as CreaPDI} from './CreaPDI';
export { default as CreaEvento} from './CreaEvento';
...
export { default as GestisciGestori } from './GestisciGestori';