...
const RecuperoPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                showAlert("Operazione completata", "Se l'account esiste, ti abbiamo inviato un link di recupero.", "success")
                setEmail('')
            } else {
            ...
            <div className="col-11 col-sm-8 col-md-6 col-lg-4">
                ...
                <div className="card border-0 shadow-sm" style={{ borderRadius: '16px' }}>
                    <div className="card-body p-4">
                        <form onSubmit={handleSubmit} noValidate>
                            <div className="mb-4">
                                ...
                                <p className="text-muted small ">
                                    Inserisci l'email o l'username per ricevere le istruzioni di ripristino.
                                </p>
                                <input
                                    type="text"
                                    name="email"
                        ...
                        <hr className="my-4" />
                        <div>
                            <button className="btn btn-outline-secondary w-100 py-2 fw-semibold" style={{ borderRadius: '10px' }} onClick={() => navigate(-1)}>
                                &larr; Torna indietro
                            </button>
                        </div>
                    </div>
